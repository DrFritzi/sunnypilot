...
_A_LAT_REG_MAX = 8.  # Maximum lateral acceleration
...
_TURNING_ACC_V = [0.8, 0., -0.4]  # acc value
_TURNING_ACC_BP = [1.5+1.5, 2.3+1.5, 3.0+1.5]  # absolute value of current lat acc

_LEAVING_ACC = 1.5  # Confortble acceleration to regain speed while leaving a turn.
